...
@Component({
  selector: 'app-apple-laptop',
  templateUrl: './apple-laptop.component.html',
  styleUrls: ['./apple-laptop.component.scss']
})
export class AppleLaptopComponent implements OnInit {
  ...
  PriceLow() {
    this.ps.getAllAppleLaptopProducts().subscribe((res: Array<Product>) => {
      this.products = res
