...
@Component({
  selector: 'app-samsung-phone',
  templateUrl: './samsung-phone.component.html',
  styleUrls: ['./samsung-phone.component.scss']
})
export class SamsungPhoneComponent implements OnInit {
  ...
  PriceLow() {
    this.ps.getAllSamsungPhonesProducts().subscribe((res: Array<Product>) => {
      this.products = res
