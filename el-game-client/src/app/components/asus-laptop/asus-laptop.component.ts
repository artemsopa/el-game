...
@Component({
  selector: 'app-asus-laptop',
  templateUrl: './asus-laptop.component.html',
  styleUrls: ['./asus-laptop.component.scss']
})
export class AsusLaptopComponent implements OnInit {
  ...
  PriceLow() {
    this.ps.getAllAsusLaptopProducts().subscribe((res: Array<Product>) => {
      this.products = res
